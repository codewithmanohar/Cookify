...
export const INGREDIENTS = [
  {
    ...
    items: [
      ...
      { name: "Cauliflower", icon: "🥦", tag: "vegan" },
      { name: "Eggplant", icon: "🍆", tag: "vegan" },
      { name: "Okra", icon: "🌱", tag: "vegan" },
      { name: "Green Peas", icon: "🫛", tag: "vegan" },
      { name: "Sweet Potato", icon: "🍠", tag: "vegan" },
      { name: "Beetroot", icon: "🟣", tag: "vegan" },
    ],
  },

  {
    ...
    categoryTag: "vegan",
    items: [
      { name: "Apple", icon: "🍎", tag: "vegan" },
      { name: "Banana", icon: "🍌", tag: "vegan" },
      { name: "Orange", icon: "🍊", tag: "vegan" },
      { name: "Mango", icon: "🥭", tag: "vegan" },
      { name: "Pineapple", icon: "🍍", tag: "vegan" },
      { name: "Grapes", icon: "🍇", tag: "vegan" },
      { name: "Watermelon", icon: "🍉", tag: "vegan" },
      { name: "Strawberry", icon: "🍓", tag: "vegan" },
      { name: "Blueberry", icon: "🫐", tag: "vegan" },
      { name: "Avocado", icon: "🥑", tag: "vegan" },
      { name: "Lemon", icon: "🍋", tag: "vegan" },
      { name: "Pear", icon: "🍐", tag: "vegan" },
    ],
  },

  {
    ...
    categoryTag: "vegan",
    items: [
      { name: "Chickpeas", icon: "🫛", tag: "vegan" },
      { name: "Lentils", icon: "🌱", tag: "vegan" },
      { name: "Black Beans", icon: "⚫", tag: "vegan" },
      { name: "Kidney Beans", icon: "🫘", tag: "vegan" },
      { name: "Soybeans", icon: "🌱", tag: "vegan" },
      { name: "Green Gram", icon: "🟢", tag: "vegan" },
      { name: "Pigeon Peas", icon: "🟡", tag: "vegan" },
    ],
  },

  {
    ...
    categoryTag: "vegan",
    items: [
      { name: "Almonds", icon: "🥜", tag: "vegan" },
      { name: "Cashews", icon: "🥜", tag: "vegan" },
      { name: "Walnuts", icon: "🌰", tag: "vegan" },
      { name: "Pistachios", icon: "🟢", tag: "vegan" },
      { name: "Peanuts", icon: "🥜", tag: "vegan" },
      { name: "Hazelnuts", icon: "🌰", tag: "vegan" },
    ],
  },

  {
    ...
    categoryTag: "vegan",
    items: [
      { name: "Chia Seeds", icon: "⚫", tag: "vegan" },
      { name: "Flax Seeds", icon: "🟤", tag: "vegan" },
      { name: "Sunflower Seeds", icon: "🌻", tag: "vegan" },
      { name: "Pumpkin Seeds", icon: "🎃", tag: "vegan" },
      { name: "Sesame Seeds", icon: "⚪", tag: "vegan" },
    ],
  },

  {
    ...
    items: [
      ...
      { name: "Chicken Wings", icon: "🍗", tag: "non-veg" },
      { name: "Ground Beef", icon: "🥩", tag: "non-veg" },
      { name: "Mutton", icon: "🍖", tag: "non-veg" },
      { name: "Turkey", icon: "🦃", tag: "non-veg" },
      { name: "Pork", icon: "🥓", tag: "non-veg" },
      { name: "Sausage", icon: "🌭", tag: "non-veg" },
    ],
  },

  {
    ...
    items: [
      ...
      { name: "Tuna", icon: "🐟", tag: "non-veg" },
      { name: "Crab", icon: "🦀", tag: "non-veg" },
      { name: "Lobster", icon: "🦞", tag: "non-veg" },
      { name: "Squid", icon: "🦑", tag: "non-veg" },
    ],
  },
...

  {
    ...
    items: [
      ...
      { name: "Quinoa", icon: "🌾", tag: "vegan" },
      { name: "Barley", icon: "🌾", tag: "vegan" },
    ],
  },

  {
    ...
    items: [
      ...
      { name: "Coriander", icon: "🌿", tag: "vegan" },
      { name: "Oregano", icon: "🌿", tag: "vegan" },
      { name: "Thyme", icon: "🌱", tag: "vegan" },
      { name: "Basil", icon: "🌿", tag: "vegan" },
...

  {
    ...
    items: [
      ...
      { name: "Tomato Paste", icon: "🍅", tag: "vegan" },
      { name: "Peanut Butter", icon: "🥜", tag: "vegan" },
    ],
  },

  {
    ...
    items: [
      ...
      { name: "Brown Sugar", icon: "🟫", tag: "vegan" },
    ],
  },
];