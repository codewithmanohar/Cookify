...
export default function PostPage() {
  ...
  useEffect(() => {
    const data = recipe.find(e => e._id == postId);
    setRecipeData(data);
  }, [postId]);
    ...
    <div className='px-4 sm:px-6 lg:px-0'>
      <div className='mx-auto container max-w-5xl my-10 sm:my-14'>
        ...
        <section className='my-8 sm:my-10 px-4 sm:px-10 py-5 bg-gray-50 rounded-xl shadow-inner'>
          ...
          {recipeData?.RECIPE_INGREDIENTS?.map((Ingredient, index) => (
        ...
        <section className='py-8 sm:py-10'>
          ...
          {recipeData?.COOKING_INSTRUCTIONS?.map((item, index) => (
            <div
              key={index}
