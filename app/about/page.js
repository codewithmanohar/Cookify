            ...
            <div className="container mx-auto">
                ...
                <div
                    className="min-h-[350px] flex flex-col items-center justify-center text-center 
                                px-4 max-w-4xl rounded-2xl mx-auto mt-32 mb-10
                                bg-cover bg-center bg-no-repeat opacity-90"
                    style={{ backgroundImage: "url('/about_bg_img2.png')" }}
                >
                    <h1 className="text-white text-5xl font-semibold py-5">
                ...
                {/* Action Button */}
                <div
                    className="min-h-[250px] flex flex-col items-center justify-center text-center px-4  max-w-4xl rounded-2xl mx-auto mt-32 mb-10 bg-cover"
                    style={{ backgroundImage: "url('/about_bg_img2.png')" }}
                >
                    <h1 className=' text-5xl font-semibold py-10 text-gray-200 '>
